...
public final class App {
    ...
    public static void main(final String[] args) {
        ...
        LOG.info(measureRandomAccess(new MyArrayList<Integer>(), size));
        LOG.info(measureRandomAccess(new MyLinkedList<Integer>(), size));

        // Measure and print insert/delete time
        LOG.info(measureDeleteFromStart(new MyArrayList<Integer>(), size,
                                                                    amount));
        LOG.info(measureDeleteFromStart(new MyLinkedList<Integer>(), size,
                                                                    amount));
    }
     ...
     */
    public static String measureRandomAccess(final MyList<Integer> list,
                                             final int size) {
     ...
     *                                  the list size
     */
    public static String measureDeleteFromStart(final MyList<Integer> list,
                                                final int size,
                                                final int amount) {
